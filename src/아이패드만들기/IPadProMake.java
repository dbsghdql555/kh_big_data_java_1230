...
public class IPadProMake {
    ...
    static int cnt = 0; // 클래스 변수 : 객체 시 생성되지 않고 클래스 생성 시 만들어짐
    public IPadProMake(String name) {
        ...
        cnt++;// 생성자는 객체가 만들어 질 때 호출 되므로 생된 객체의 횟수를 확인하는 용도로 사용할 수 있다.
    ...
    // 일련 번호 만들기 : iPad + 11/13 + 128/256/512/1024 + W/C + 230112 + 생산갯수
    void setSerialNum() {
    ...
    // 제품 구매가 완료 되면 출고까지 30초 대기 이후 출고하기
