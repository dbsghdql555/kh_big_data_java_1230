...
public class ThreadEx2 {
    public static void main(String[] args) {
        ...
        Runnable run = new RunThread(); // 수행 해야할 작업내용은 포함하고 있지만 실제 쓰레드는 아님
        Thread runTh1 = new Thread(run); // 실제 작업 내용을 쓰레드에 넣어 작동시키게 만듬
        runTh1.start();
        // 익명의 객체 생성
        ...
        Thread runThr4 = new Thread(task2);
        runThr4.start();
