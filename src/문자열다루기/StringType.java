...
public class StringType {
    public static void main(String[] args) {
        ...
        //replaceAll : 문자열 중 특정 문자열을 다른 문자열로 대체 할때 사용
        String language = "Java, Python, C, C++, Javascript, Kotlin, Swift";
        System.out.println(language.replaceAll("Kotlin", "Jet Brain"));
        System.out.println(language.replaceAll("Javascript", ""));// 문자열을 없앰
        String e = "Hello Java";
        //substring : 문자열에서 특정 문자열을 뽑아낼 때 사용
        System.out.println(e.substring(6)); //시작 인덱스 부터 끝까지 추출
        System.out.println((e.substring(1, 4))); // 시작 인덱스부터 종료 인덱스 미만 까지 추출
        // toUpperCase / toLowerCase : 문자열을 모두 대문자 또는 소문자로 만들어줌
